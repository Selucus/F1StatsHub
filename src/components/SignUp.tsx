...
const SignUp: FC = () => {
  return <div className="container mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[400px]">
    <div className="flex flex-col space-y-2 text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">Welcome to F1 Stats Hub</h1>
        <p className="text-sm max-w-xs mx-auto">
            By continuing, you are joining F1 Stats Hub and agreeing to Privacy and User Policy
        </p>
